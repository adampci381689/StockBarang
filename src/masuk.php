                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    while($data=mysqli_fetch_array($ambilsemuadatastock)){
                                            ...
                                            $qty = $data['qty'];
                                            $Unit = $data['Unit'];
                                            $Penerima_Barang = $data['Penerima_Barang'];
                                    ?>
                                    <tr> 
                                            <td><?=$Tanggal;?></td>
                                            <td><?=$Nama_Barang;?></td>
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    ...
    <?php
      ...
      <br>
      <input type="text" name="Penerima_Barang" class="form-control" placeholder="Penerima Barang" required>
      <br> 
